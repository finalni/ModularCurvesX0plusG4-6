...
#18-Jan-22: Recently, QCMod package was updated. One needs to pass additional precision argument for our examples to work, as it is done in this readme.file. Usually N:=20 #suffices, but for some curves (levels 173, 197, 269 and 359), one can set precision to N:=30 (for 211, set N:=40)..
########################################################
